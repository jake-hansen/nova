...
public class DBPropertiesUtility {
	...
	static String _PROP_FILENAME_WIN_LOCAL = "YOUR\\LOCAL\\PATH\\config.properties";
	static String _PROP_FILENAME_OSX_LOCAL = "/YOUR/LOCAL/PATH/config.properties";
	// * Remote server path
	static String _PROP_FILENAME_REMOTE = "/opt/tomcat/webapps/nova/config.properties";
